...
class AzureBlobManagement:
    ...
    def __init__(self,connection_string=None):
        try:
            ...
            raise Exception('free trial subscription for azure blob account has been expired '+"Error occured in class: AzureBlobManagement method:__init__ error: " + str(e))
